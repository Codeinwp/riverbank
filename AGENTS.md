# Agent Guide — Riverbank

## Overview

Riverbank is a block-based WordPress theme built for Full Site Editing. PHP theme code lives in the `Riverbank` namespace under `inc/`; the theme also provides block patterns, templates, template parts, styles, and JavaScript and SCSS assets.
...
- Put PHP theme behavior in the existing `Riverbank` namespace and preserve the current class structure.
